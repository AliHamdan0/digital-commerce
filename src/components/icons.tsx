    ...
    <svg {...props} viewBox="0 0 512 512">
      <g>
        ...
        <path
          ...
          opacity="1"
        ></path>
        <ellipse cx="256" cy="244.04" rx="196.34" ry="186.42" fill="#60a5fa" data-original="#abdfeb" opacity="1"></ellipse>
        <path
        ...
        <path
          ...
          opacity="1"
        ></path>
        <circle cx="149.39" cy="259.56" r="15.519" fill="#558ce7" data-original="#8bcdd8" opacity="1"></circle>
        <circle cx="362.61" cy="259.56" r="15.519" fill="#558ce7" data-original="#8bcdd8" opacity="1"></circle>
        <path
